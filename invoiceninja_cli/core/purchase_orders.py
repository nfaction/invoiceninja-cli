"""Purchase order resource operations for InvoiceNinja."""
...
_ENTITY = "purchase_orders"


class PurchaseOrderResource:
    """CRUD + bulk operations on InvoiceNinja purchase orders."""
    ...
    def list(
        ...
        **kwargs: Any) -> dict:
        ...
        params: Dict[str, Any] = {"page": page, "per_page": per_page, "include": "vendor"}
        if filter:
