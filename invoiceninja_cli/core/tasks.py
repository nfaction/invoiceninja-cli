"""Task resource operations for InvoiceNinja."""
...
class TaskResource:
    """CRUD + bulk operations on InvoiceNinja tasks."""
    ...
    def create(self, data: Dict[str, Any]) -> dict:
        ...
        Expected data keys:
            ...
            project_id (str): Associated project ID (optional).
            time_log (list): Time log entries (optional).
        """
